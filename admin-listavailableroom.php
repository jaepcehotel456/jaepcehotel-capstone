       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=admin-listavailableroom&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=admin-listavailableroom&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=admin-listavailableroom&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }

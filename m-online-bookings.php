                    ...
                    <div class="card card-register my-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-10">
                                  <a href="./?page_id=m-checkout-rooms" class="text-white float-right"><button class="btn btn-info btn-md text-right">Check Out Rooms</button></a>
                                </div> -->
                            </div>
                                       ...
                                       <!-- Fetch Data Each Row -->
                                            ...
                                            <tr>
                                                ...
                                                <!-- <input type="button" name="view" value="View" id="<//?php echo $row['transaction_id']; ?>" class="btn btn-warning view_data" data-target="#view_data_modal" data-toggle="modal">
                                                   ...
                                                   <td>
                                                <form class="form-register" method="POST" action="m-Check-in-proc" enctype="multipart/form-data">
                                                <div class="col-sm-10">
                                                <!-- <br> -->
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=m-online-bookings&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=m-online-bookings&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=m-online-bookings&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }

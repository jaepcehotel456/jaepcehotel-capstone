<?php include('m-navbar.php'); include('dbconnection.php'); ?> 
   						...
   						<div class="card-body">
   							<div class="row">
				                  ...
				                  <option value="?page_id=m-checkout-rooms">Currently Check In's</option>
	   							...
	   							<!-- Pending -->
	   							<!-- <div class="col-md-10">
	   								<a href="./?page_id=m-online-bookings" class="text-white float-right"><button class="btn btn-info btn-md text-right">Online Booking Transactions </button></a>
	   							</div> -->
<!-- 	   							<div class="col-md-2">
	   								<a href="" class="text-white"><button class="btn btn-success btn-md text-right">Paid Booking</button></a>
	   							</div> -->
   							</div>
	                                   ...
	                                   <!-- Fetch Data Each Row -->
	                                    ...
	                                    <tr>
	                                    		...
	                                    		<td>
	                                    			...
	                                    			<a onclick="return confirm('Are you sure you want to cancel reservation?')" href="./?page_id=m-pending-cancel&transaction_id=<?php echo $row['transaction_id'];?>" type="button" class="btn btn-danger">Cancel Reservation</a>
	                                    		</td>
	                                    	</tr>
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=m-pending-reservation&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=m-pending-reservation&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=m-pending-reservation&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }

...
<?php
	...
	$query = mysqli_query($databaseconnection, "SELECT * FROM `coupon` WHERE `coupon` = '$coupon_code' && `status` = 'Valid'") or die(mysqli_error());
		...
		<form action="" method="POST" name="">
			<span id="printout">
				...
				<table style="border: solid 1px;">
					...
					<tfoot>
						<tr>
							<td><h5>PROMO CODE:<?php echo $discounts; ?><h5></td>
						</tr>
						<tr>

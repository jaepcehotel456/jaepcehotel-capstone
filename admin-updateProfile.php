 ...
 <!-- Register Page Content -->
        <section class="section-register py-2">
            <div class="container">
                ...
                <form class="form-register" method="POST" action="admin-updateProfileProcess" enctype="multipart/form-data">
                    <input type='hidden' name='id' value='<?php echo $data['person_id'];?>'>
                                         ...
                                         <div class="col-sm-5">
                                                ...
                                                <div class="form-label-group">
                                                   ...
                                                   <!--  <label for="inputPhoneNumber" class="label-test">Phone Number</label> -->
                                                    <input type="hidden" name="person_type" value="admin">
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                 <div class="d-block">

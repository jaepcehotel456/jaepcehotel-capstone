                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <table class="c-db-table-info">
                                                    <thead>
                                                        <tr><h3 class="m-profile"><?php echo $data['gender']; ?> <?php echo ucfirst($data['fname']); ?> <?php echo ucfirst($data['midname']); ?>. <?php echo ucfirst($data['lname']); ?> </h3></tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
                                           ...
                                           <div class="col-sm-4 c-db-info-4">
                                            <div class="row">
                                              ...
                                              <!--  style="width:50%;height:200px;" -->
                                               ...
                                               <div class="row my-1">
                                                    <a href="?page_id=m-updateProfile" class="c-db-btn">Update Profile</a>
                                               </div>
                                            </div>

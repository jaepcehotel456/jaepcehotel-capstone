                                       ...
                                       <!-- Fetch Data Each Row -->
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                 ...
                                                 ?>
                                                 <a onclick="return confirm('Customer hasnt paid yet')" href="?page_id=s-checkout-rooms&transaction_id=<?php echo $row['transaction_id'];?>&room_id=<?php echo $row['room_no'];?>" class="btn btn-danger">Check Out</a>
                                                 <?php
                                                 }else{
                                                 ?> 
                                                <a href="?page_id=s-checkout-rooms&transaction_id=<?php echo $row['transaction_id'];?>&room_id=<?php echo $row['room_no'];?>" class="btn btn-danger">Check Out</a>
                                                <?php
                                                }?>
                                                </td>
                                               <!-- <br> -->
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=staff-checkout-rooms&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=staff-checkout-rooms&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=staff-checkout-rooms&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }

<?php include('admin-navbar.php');  include('dbconnection.php');?>
   					...
   					<div class="card card-register my-2">
   						<div class="card-body">
   							<div class="row">
	   							...
	   							<!-- <div class="col-md-2">
	   								<a href="?page_id=admin-transaction" class="text-white"><button class="btn btn-success btn-md text-right">Walk-In Transactions</button></a>
	   							</div> -->
	   							<!-- Pending -->
	   							<!-- <div class="col-md-10">
	   								<a href="./?page_id=admin-online-bookings" class="text-white float-right"><button class="btn btn-info btn-md text-right">Online Booking Transactions </button></a>
	   							</div> -->
	   							<div class="col-md-2">
                                    ...
                                    <table class="table table-md table-hover table-center table-bordered order-table">
	                                   ...
	                                   <!-- Fetch Data Each Row -->
	                                    	...
	                                    	<tr>
	                                    		...
	                                    		<td><?php echo $createdby['createdby']; ?></td> 
	                                    		...
	                                    		<td>
	                                    			...
	                                    			<a onclick="return confirm('Are you sure you want to cancel reservation?')" href="./?page_id=admin-pending-cancel&transaction_id=<?php echo $row['transaction_id'];?>" type="button" class="btn btn-danger">Cancel Reservation</a>
	                                    		</td>
	                                    	</tr>
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=admin-pending-reservation&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=admin-pending-reservation&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=admin-pending-reservation&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }
			        ...
			        <!-- <div class="container"> -->
			            ...
			            <form method="POST" id="insert_form">
			                    ...
			                    <!-- Check In -->
		                      		<div class="row">
		                      		  ...
		                      		  <div class="col-sm-10">
			                                 ...
			                                 <input type="text" name="room_no" id="room_no" disabled>            
		                                  	</div>
			                          </div>
			                ...
			                <div class="col-lg-12">
			                    <div class="container">
			                        <div class="row">
			                                <input type="submit" name="insert" id="insert" value="Approve" class="btn btn-primary">

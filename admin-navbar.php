...
// header("Refresh: 60; URL=?page_id=admin-pending-reservation");
...
?>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
                <li><a href="?page_id=admin-dashboard">Dashboard</a></li>
                <li><a href="?page_id=admin-room">Create Room</a></li>
                <li><a href="?page_id=admin-account">Create Account</a></li>
                <li><a href="?page_id=admin-webpage">Webpage</a></li>
            </ul>
        </nav>
                    ...
                    <div class="col-lg-10">
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                     ...
                                     <ul>
                                        <li><a href="?page_id=admin-dashboard">Dashboard</a></li>
                                        <li><a href="?page_id=admin-transaction">Transactions</a></li>
                                        <li><a href="?page_id=admin-room">Manage Rooms</a></li>
                                        <li><a href="?page_id=admin-listOfManagers">Managers</a></li>
                                        <li><a href="?page_id=admin-listOfStaff">Staffs</a></li>
                                        <li><a href="?page_id=admin-listOfGuest">Guest</a></li>
                                            <li class="dropdown">
        ...
        <div class="top-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="tn-right">
                            <a href="?page_id=admin-profile" class="bk-btn mb-2">Profile</a>

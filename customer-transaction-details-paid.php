...
header('Location: ./?page_id=customer-dashboard');
				...
				<table style="border: solid 1px;">
					...
					<tfoot>
						<tr>
							...
							?>
							<td align="left"><h5>Discount: <?php echo $discounts ?>% </h5></td>
							<?php
								}else{
									$discounts = 'No Discount';
									?>
									<td ><h5><b>Discount: <?php echo 'No Discount' ?> </b></h5></td>
								<?php }
							?>
						</tr>
						<tr>
					...
					<p class="mt-2">We are eagerly anticipating your arrival and would like to advise you of the following in order to help you with your trip planning. Your reservation number is <b><?php echo $data['confirmation']?>:</b><br/><br/>Your transaction ID is <b><?php echo $tid; ?></b><br/ >Should there be a concern with your reservation, a customer service representative will contact you. Otherwise, consider your reservation confirmed.</p>
					<ul class="ml-3">

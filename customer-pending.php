            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text text-left">
                        <h2 class="text-white">Pending Reservation</h2>
                    </div>
                </div>
            </div>
        </div>
 ...
 <section class="section-register py-2">
            ...
            ?>
                        <tr>
                            ...
                            <td><?php echo ucfirst($book_hist_dets->transaction_type);?></td>
...
<!--START COUNT LIMITER PAGINATION -->
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                $sql = "SELECT COUNT(transaction_id) as total FROM transaction WHERE person_id = '$person_id' AND transaction_type = 'pending'"; 
                ...
                if ($page_hist != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=customer-pending&page_hist=".($page_hist-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=customer-pending&page_hist=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            <?php
             ...
             if ($page_hist != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=customer-pending&page_hist=".($page_hist+1)."' class='ml-2'>NEXT</a></div></li>";
              }

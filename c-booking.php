                                    ...
                                    <!--	 
                                    	 <div class="col-sm-5">
                                                 <div class="tn-right">                                                   
                                                        ...
                                                        <button type="submit" name="submit" class="btn-join btn-sm btn-primary text-uppercase">Submit</button>
                                                        </div>
                                        		 </div>
                                         </div>
                                     -->
                                     <!--
                                        ...
                                        <div class="col-sm-5">
                                         	...
                                         	<div class="col-sm-5">
                                         		<br>
                                                 <div class="d-block">
                                                         <button onclick="return confirm('Do you want to continue?  ')" class="btn-join btn-lg btn-primary text-uppercase" name="reservebtn" id="submitBtn" data-toggle="modal" data-target="#confirm-submit">Reserve only</button>
...
<script src="https://www.paypal.com/sdk/js?client-id=ATgeWa2hx15X82AYktLW_y3AITEEa3NeCPTpTUYOM3UZwNEPkdzhYM652E-AZDh4C5NFPw5IcdrF6E8z&disable-funding=credit,card"></script>

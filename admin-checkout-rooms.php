                ...
                <div class="col-md-12 mx-auto">
                    <div class="card card-register my-2">
                        <div class="card-body">
                            <div class="row">
                                <!-- <div class="col-md-2">
                                    <a href="?page_id=admin-online-bookings" class="text-white"><button class="btn btn-success btn-md text-right">Online Bookings</button></a>
                                </div> -->
                                <div class="col-md-2">
                                       ...
                                       <!-- Fetch Data Each Row -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 ?>
                                                 <a onclick="return confirm('Customer hasnt paid yet')" href="?page_id=checkout-rooms&transaction_id=<?php echo $row['transaction_id'];?>&room_id=<?php echo $row['room_no'];?>" class="btn btn-danger">Check Out</a>
                                                 <?php
                                                 }else{
                                                 ?>   
                                                <a href="?page_id=checkout-rooms&transaction_id=<?php echo $row['transaction_id'];?>&room_id=<?php echo $row['room_no'];?>" class="btn btn-danger">Check Out</a>
                                                <?php
                                                }?>
                                                </td>
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=admin-checkout-rooms&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=admin-checkout-rooms&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=admin-checkout-rooms&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }

<?php include('admin-navbar.php'); ?>
 ...
 <!--   								<a href="?page_id=admin-pending-reservation" class="text-white"><button class="btn btn-success btn-md text-right">Pending Reservations</button></a>
                  ...
                  <option value="?page_id=admin-transaction">Transaction</option>
                  <option value="?page_id=admin-pending-reservation">Pending Reservation</option>
                  <option value="?page_id=admin-online-bookings">Online Bookings</option>
                ...
                <!-- TESTING WITH LATEST COMPILATED LIBRARIES IN HEADER -->
<!--                 <div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    All Transactions
                  </button>
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="?page_id=admin-pending-reservation">Pending Reservations</a>
                    <a class="dropdown-item" href="?page_id=admin-transaction">Walk-In Transactions</a>
                    <a class="dropdown-item" href="?page_id=admin-online-bookings">Online Bookings</a>
                    <a class="dropdown-item" href="?page_id=admin-checkout-rooms">All Check In's</a>
                  </div>
                </div> -->
                <!--END TESTING WITH LATEST COMPILATED LIBRARIES IN HEADER -->
   							<!-- Pending -->
                ...
                <center>
                 ...
                 <!--  <div class="container" style="border-style: groove;">
                  ...
                  <form class="mt-5" enctype="multipart/form-data"  method="POST" action="admin-t-p">
                    <div class="container" style="border-style: groove;">
                    <div class="form-row">
                      <div class="form-group col-md-3">
                        ...
                        <input hidden>
                          ...
                          <?php
                            ...
                            echo "<label>Guest Name</label>";
                            echo "<center>";
                            echo "<select name='person_id' id='searchddl' required>";
                      ...
                      <br><br>
                            ...
                            echo "<center>";
                            echo "<select name='room_id' id='searchroom' required>";
                    ...
                    <div class="form-group">
                      ...
                      <input type = "number" class = "form-control" min = "0" max="3" name = "extra_bed"  placeholder="Input Extra bed" />
                    </div>
                    <div class="form-group">

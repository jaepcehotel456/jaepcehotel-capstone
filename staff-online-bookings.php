                    ...
                    <div class="card card-register my-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-10">
                                  <a href="./?page_id=staff-checkout-rooms" class="text-white float-right"><button class="btn btn-info btn-md text-right">Check Out Rooms</button></a>
                                </div> -->
                            </div>
                                ...
                                <table class="table table-md table-hover table-center table-bordered order-table">
                                       ...
                                       <!-- Fetch Data Each Row -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form class="form-register" method="POST" action="staff-Checkin-Customer" enctype="multipart/form-data">
                                                <div class="col-sm-10">
       ...
       <!-- Counter for page *Start* -->
            <?php 
                ...
                if ($page_num != 1) {
                  ...
                  <div class='room-pagination'><a href='?page_id=staff-online-bookings&page_num=".($page_num-1)."' class='ml-2'>PREV</a></div></li>";
                     }
            ...
            <a href="?page_id=staff-online-bookings&page_num=<?php echo $i?>" class="ml-2"><?php echo $i ?></a>
            </div>
            ...
            if ($page_num != $total_pages) {
                  echo "<li style='display:inline-block; display:inline;zoom:1;margin-right:10px;'>
                <div class='room-pagination'><a href='?page_id=staff-online-bookings&page_num=".($page_num+1)."' class='ml-2'>NEXT</a></div></li>";
              }
                                 ...
                                 Days Stay 
                                    ...
                                    <Contact Number 
                                      ...
                                      <div class="col-sm-10">
                                            ...
                                            < <input type="hidden" name="transaction_type" id="transaction_type" value="CheckIn">  -->         
                                            <!-- </div>
                                      </div>

   			...
   			<div class="row my-5" style="background-color:#dfa974">
                ...
                <center>
                 ...
                 <!--  <div class="container" style="border-style: groove;">
                  ...
                  <form enctype="multipart/form-data"  method="POST" action="m-t-p">
                    <div class="container" style="border-style: groove;">
                    <div class="form-row">
                    ...
                    <div class="form-row mt-3">
                      <div class="form-group col-md-6">
                        ...
                        <input type = "date" class = "form-control" data-link-format="yyyy-mm-dd" name = "checkin" required = "required" min="<?php echo $date ?>" />
                      </div>
                      <div class="form-group col-md-6">
                        <label for="Check-out">Check-out</label>
                        <input type = "date" class = "form-control" data-link-format="yyyy-mm-dd" name = "checkout" required = "required" min="<?php echo $date ?>" />
                      </div>
                    </div>
